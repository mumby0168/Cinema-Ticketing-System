...
{
    public class ViewAScreeningViewModel : BaseViewModel
    {
        ...
        {
            Passer(_selectedScreening.Id);
        }

        private Action<int> Passer;

        public ViewAScreeningViewModel(Action<int> passer)
        {
            Passer = passer;
